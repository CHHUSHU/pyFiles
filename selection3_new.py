...
aPositive = excel.loc[excel['95d'] > 9.41, ['Sample', '95d']]
bPositive = excel.loc[excel['94E'] > 3.32, ['Sample', '94E']]
cPositive = excel.loc[excel['132A'] > 9.11, ['Sample', '132A']]
dPositive = excel.loc[excel['90F'] > 10.92, ['Sample', '90F']]
ePositive = excel.loc[excel[8601] > 2.56, ['Sample', 8601]]
fPositive = excel.loc[excel[2801] > 6.84, ['Sample', 2801]]
gPositive = excel.loc[excel['155D'] > 4.72, ['Sample', '155D']]

title = ['SampleID:', '95d:', '94E:', '132A:', '90F:', '8601:', '2801:', '155D:', '判断:']
doc = Document()
...
for ID in IDs:
    ...
    patient = {'SampleID:': ID, '95d:': a, '94E:': b, '132A:': c,
               '90F:': d, '8601:': e, '2801:': f, '155D:': g, '判断:': x}
    print(patient)
    TEXT = [ID, a, b, c, d, e, f, g, x]
    A = 0
    while A < 9:
        ad = table.rows[B].cells[A].add_paragraph(TEXT[A])
        A += 1
    B += 1
